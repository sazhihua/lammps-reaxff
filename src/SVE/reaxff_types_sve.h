...
#ifndef LMP_REAXFF_TYPES_SVE_H
#define LMP_REAXFF_TYPES_SVE_H

#include "lmptype.h"

#include "reaxff_defs_sve.h"      // IWYU pragma: export
#include "reaxff_inline_sve.h"    // IWYU pragma: export
...
struct reax_system {
  ...
  // added by ping
  LAMMPS_NS::NeighList *list; 
  LAMMPS_NS::NeighList *listfull; 
  double **x;
  double *q;
  int *type;
  int *map;
...
// Do NOT modify the variable layout inside the following structure !!!!!
struct bond_order_data {
  ...
  // double dBOp_fac, dln_BOp_s_fac, dln_BOp_pi_fac, dln_BOp_pi2_fac;
