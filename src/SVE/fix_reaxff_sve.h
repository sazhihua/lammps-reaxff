...
#ifdef FIX_CLASS
// clang-format off
FixStyle(REAXFF/sve,FixReaxFFSVE);
// clang-format on
#else

#ifndef LMP_FIX_REAXFF_SVE_H
#define LMP_FIX_REAXFF_SVE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixReaxFFSVE : public Fix {
  friend class PairReaxFFSVE;
  friend class PairReaxFFOMP;

 public:
  FixReaxFFSVE(class LAMMPS *, int, char **);
  ~FixReaxFFSVE() override;
