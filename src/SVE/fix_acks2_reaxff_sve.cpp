...
FixACKS2ReaxFFSVE::FixACKS2ReaxFFSVE(LAMMPS *lmp, int narg, char **arg) :
  FixQEqReaxFFSVE(lmp, narg, arg)
{
  bcut = nullptr;
...
FixACKS2ReaxFFSVE::~FixACKS2ReaxFFSVE()
{
  if (copymode) return;
  ...
  FixACKS2ReaxFFSVE::deallocate_storage();
  FixACKS2ReaxFFSVE::deallocate_matrix();
}

/* ---------------------------------------------------------------------- */

void FixACKS2ReaxFFSVE::post_constructor()
{
...
void FixACKS2ReaxFFSVE::pertype_parameters(char *arg)
{
...
void FixACKS2ReaxFFSVE::allocate_storage()
{
  nmax = atom->nmax;
...
void FixACKS2ReaxFFSVE::deallocate_storage()
{
...
void FixACKS2ReaxFFSVE::allocate_matrix()
{
  FixQEqReaxFFSVE::allocate_matrix();
...
void FixACKS2ReaxFFSVE::deallocate_matrix()
{
...
void FixACKS2ReaxFFSVE::init()
{
  FixQEqReaxFFSVE::init();
...
void FixACKS2ReaxFFSVE::init_bondcut()
{
  int i,j;
  int ntypes;
...
void FixACKS2ReaxFFSVE::init_storage()
{
...
void FixACKS2ReaxFFSVE::pre_force(int /*vflag*/)
{
...
void FixACKS2ReaxFFSVE::init_matvec()
{
  /* fill-in H matrix */
  compute_H();
...
void FixACKS2ReaxFFSVE::compute_X()
{
  int jnum;
  int i, j, ii, jj, flag;
...
double FixACKS2ReaxFFSVE::calculate_X(double r, double bcut)
{
  double d = r/bcut;
  double d3 = d*d*d;
  double omd = 1.0 - d;
...
int FixACKS2ReaxFFSVE::BiCGStab(double *b, double *x)
{
  int  i, j;
...
void FixACKS2ReaxFFSVE::sparse_matvec_acks2(sparse_matrix *H, sparse_matrix *X, double *x, double *b)
{
  int i, j, itr_j;
  int ii;
...
void FixACKS2ReaxFFSVE::calculate_Q()
{
  pack_flag = 2;
  comm->forward_comm(this); //Dist_vector(s);
...
int FixACKS2ReaxFFSVE::pack_forward_comm(int n, int *list, double *buf,
...
void FixACKS2ReaxFFSVE::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m;
...
int FixACKS2ReaxFFSVE::pack_reverse_comm(int n, int first, double *buf)
{
  int i, m;
  m = 0;
  int last = first + n;
...
void FixACKS2ReaxFFSVE::unpack_reverse_comm(int n, int *list, double *buf)
{
  int j;
  int m = 0;
  if (pack_flag == 1) {
...
void FixACKS2ReaxFFSVE::more_forward_comm(double *vec)
{
...
void FixACKS2ReaxFFSVE::more_reverse_comm(double *vec)
{
  if (last_rows_flag)
...
double FixACKS2ReaxFFSVE::memory_usage()
{
  double bytes;
...
void FixACKS2ReaxFFSVE::grow_arrays(int nmax)
{
...
void FixACKS2ReaxFFSVE::copy_arrays(int i, int j, int /*delflag*/)
{
...
int FixACKS2ReaxFFSVE::pack_exchange(int i, double *buf)
{
...
int FixACKS2ReaxFFSVE::unpack_exchange(int nlocal, double *buf)
{
...
double FixACKS2ReaxFFSVE::parallel_norm(double *v, int n)
{
  int  i;
...
double FixACKS2ReaxFFSVE::parallel_dot(double *v1, double *v2, int n)
{
  int  i;
  double my_dot, res;
...
double FixACKS2ReaxFFSVE::parallel_vector_acc(double *v, int n)
{
  int  i;
  double my_acc, res;
...
void FixACKS2ReaxFFSVE::vector_sum(double* dest, double c, double* v,
...
void FixACKS2ReaxFFSVE::vector_add(double* dest, double c, double* v, int k)
{
  int kk;
...
void FixACKS2ReaxFFSVE::vector_copy(double* dest, double* v, int k)
{
  int kk;
