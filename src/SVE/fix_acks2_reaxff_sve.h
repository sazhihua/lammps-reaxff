...
#ifdef FIX_CLASS
// clang-format off
FixStyle(acks2/reax/sve,FixACKS2ReaxFFSVE);
FixStyle(acks2/reaxff/sve,FixACKS2ReaxFFSVE);
// clang-format on
#else

#ifndef LMP_FIX_ACKS2_REAXFF_SVE_H
#define LMP_FIX_ACKS2_REAXFF_SVE_H

#include "fix_qeq_reaxff_sve.h"

namespace LAMMPS_NS {

class FixACKS2ReaxFFSVE : public FixQEqReaxFFSVE {
 public:
  FixACKS2ReaxFFSVE(class LAMMPS *, int, char **);
  ~FixACKS2ReaxFFSVE() override;
