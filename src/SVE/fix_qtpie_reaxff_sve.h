...
#ifdef FIX_CLASS
// clang-format off
FixStyle(qtpie/reaxff/sve,FixQtpieReaxFFSVE);
// clang-format on
#else

#ifndef LMP_FIX_QTPIE_REAXFF_SVE_H
#define LMP_FIX_QTPIE_REAXFF_SVE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixQtpieReaxFFSVE : public Fix {
 public:
  FixQtpieReaxFFSVE(class LAMMPS *, int, char **);
  ~FixQtpieReaxFFSVE() override;
