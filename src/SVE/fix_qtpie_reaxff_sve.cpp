...
FixQtpieReaxFFSVE::FixQtpieReaxFFSVE(LAMMPS *lmp, int narg, char **arg) :
...
FixQtpieReaxFFSVE::~FixQtpieReaxFFSVE()
{
  if (copymode) return;
  ...
  FixQtpieReaxFFSVE::deallocate_storage();
  FixQtpieReaxFFSVE::deallocate_matrix();
...
void FixQtpieReaxFFSVE::post_constructor()
{
...
void FixQtpieReaxFFSVE::pertype_parameters(char *arg)
{
...
void FixQtpieReaxFFSVE::allocate_storage()
{
  nmax = atom->nmax;
...
void FixQtpieReaxFFSVE::deallocate_storage()
{
  memory->destroy(s);
  memory->destroy(t);
...
void FixQtpieReaxFFSVE::reallocate_storage()
{
  deallocate_storage();
  allocate_storage();
  init_storage();
...
void FixQtpieReaxFFSVE::allocate_matrix()
{
  int i,ii;
  bigint m;
...
void FixQtpieReaxFFSVE::deallocate_matrix()
{
...
void FixQtpieReaxFFSVE::reallocate_matrix()
{
  deallocate_matrix();
  allocate_matrix();
}
...
double FixQtpieReaxFFSVE::compute_scalar()
{
  return matvecs/2.0;
}
...
void FixQtpieReaxFFSVE::init_list(int /*id*/, NeighList *ptr)
{
  list = ptr;
}
...
void FixQtpieReaxFFSVE::init_shielding()
{
  int i,j;
  int ntypes;
...
void FixQtpieReaxFFSVE::init_taper()
{
...
void FixQtpieReaxFFSVE::init_olap()
{
  int i,j;
  int ntypes;
...
void FixQtpieReaxFFSVE::setup_pre_force(int vflag)
{
  if (reaxff) {
    nn = reaxff->list->inum;
...
void FixQtpieReaxFFSVE::setup_pre_force_respa(int vflag, int ilevel)
{
...
void FixQtpieReaxFFSVE::min_setup_pre_force(int vflag)
{
  setup_pre_force(vflag);
}
...
void FixQtpieReaxFFSVE::init_storage()
{
  calc_chi_eff();
...
void FixQtpieReaxFFSVE::pre_force(int /*vflag*/)
{
...
void FixQtpieReaxFFSVE::pre_force_respa(int vflag, int ilevel, int /*iloop*/)
{
...
void FixQtpieReaxFFSVE::min_pre_force(int vflag)
{
  pre_force(vflag);
}
...
void FixQtpieReaxFFSVE::init_matvec()
{
  /* fill-in H matrix */
  compute_H();
...
void FixQtpieReaxFFSVE::compute_H()
{
  int jnum;
  int i, j, ii, jj, flag;
...
double FixQtpieReaxFFSVE::calculate_H(double r, double gamma)
{
  double Taper, denom;
...
int FixQtpieReaxFFSVE::CG(double *b, double *x)
{
  int  i, j;
...
void FixQtpieReaxFFSVE::sparse_matvec(sparse_matrix *A, double *x, double *b)
{
  int i, j, itr_j;
  int ii;
...
void FixQtpieReaxFFSVE::calculate_Q()
{
  int i, k;
...
int FixQtpieReaxFFSVE::pack_forward_comm(int n, int *list, double *buf,
...
void FixQtpieReaxFFSVE::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m;
...
int FixQtpieReaxFFSVE::pack_reverse_comm(int n, int first, double *buf)
{
  int i, m;
...
void FixQtpieReaxFFSVE::unpack_reverse_comm(int n, int *list, double *buf)
{
...
double FixQtpieReaxFFSVE::memory_usage()
{
  double bytes;
...
void FixQtpieReaxFFSVE::grow_arrays(int nmax)
{
...
void FixQtpieReaxFFSVE::copy_arrays(int i, int j, int /*delflag*/)
{
...
int FixQtpieReaxFFSVE::pack_exchange(int i, double *buf)
{
...
int FixQtpieReaxFFSVE::unpack_exchange(int nlocal, double *buf)
{
...
double FixQtpieReaxFFSVE::parallel_norm(double *v, int n)
{
  int  i;
...
double FixQtpieReaxFFSVE::parallel_dot(double *v1, double *v2, int n)
{
  int  i;
  double my_dot, res;
...
double FixQtpieReaxFFSVE::parallel_vector_acc(double *v, int n)
{
  int  i;
  double my_acc, res;
...
void FixQtpieReaxFFSVE::vector_sum(double* dest, double c, double* v,
...
void FixQtpieReaxFFSVE::vector_add(double* dest, double c, double* v, int k)
{
  int kk;
...
void FixQtpieReaxFFSVE::calc_chi_eff()
{
  ...
  for (i = 0; i < nn; i++) {
    ...
    if (efield) {
      ...
      } else { // atom-style potential from FixEfieldSVE
...
double FixQtpieReaxFFSVE::find_min_exp(const double *array, const int array_length)
{
