...
#ifndef LMP_REAXFF_API_SVE_H
#define LMP_REAXFF_API_SVE_H

#include "reaxff_types_sve.h"    // IWYU pragma: export
...
extern int BOp_single(storage *, reax_list *, double, int, int, far_neighbor_data *,
               single_body_parameters *, single_body_parameters *, two_body_parameters *);
...
extern void Hydrogen_Bonds_nohlist(reax_system *, simulation_data *, storage *, reax_list **, control_params*);
...
extern void Valence_and_Torsion_Angles(reax_system *, control_params *, simulation_data *, storage *,
                           reax_list **);
...
__always_inline void set_range(int &start, int &end, int ithr, int nthr, int n) 
{
  int perthr = n / nthr;
  int remthr = n % nthr;
