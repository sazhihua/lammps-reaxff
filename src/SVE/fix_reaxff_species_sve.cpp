...
#include "fix_reaxff_species_sve.h"
...
FixReaxFFSpeciesSVE::FixReaxFFSpeciesSVE(LAMMPS *lmp, int narg, char **arg) :
...
FixReaxFFSpeciesSVE::~FixReaxFFSpeciesSVE()
{
...
int FixReaxFFSpeciesSVE::setmask()
{
  int mask = 0;
  mask |= POST_INTEGRATE;
  return mask;
...
void FixReaxFFSpeciesSVE::setup(int /*vflag*/)
{
...
void FixReaxFFSpeciesSVE::init_list(int /*id*/, NeighList *ptr)
{
  list = ptr;
}
...
void FixReaxFFSpeciesSVE::post_integrate()
{
...
void FixReaxFFSpeciesSVE::Output_ReaxFF_Bonds(bigint ntimestep, FILE * /*fp*/)
...
AtomCoordSVE FixReaxFFSpeciesSVE::chAnchor(AtomCoordSVE in1, AtomCoordSVE in2)
{
  if (in1.x < in2.x)
    return in1;
  else if (in1.x == in2.x) {
...
void FixReaxFFSpeciesSVE::FindMolecule()
{
...
void FixReaxFFSpeciesSVE::SortMolecule(int &Nmole)
{
...
void FixReaxFFSpeciesSVE::FindSpecies(int Nmole, int &Nspec)
{
...
int FixReaxFFSpeciesSVE::CheckExistence(int id, int nutypes)
{
  int i, j, molid, flag;
...
void FixReaxFFSpeciesSVE::GetUniqueElements()
{
  eleflag = 1;
...
void FixReaxFFSpeciesSVE::WriteFormulas(int Nmole, int Nspec)
{
  int i, j, itemp;
...
void FixReaxFFSpeciesSVE::OpenPos()
{
  if (comm->me == 0) {
...
void FixReaxFFSpeciesSVE::WritePos(int Nmole, int Nspec)
{
  int i, itype, cid;
...
void FixReaxFFSpeciesSVE::DeleteSpecies(int Nmole, int Nspec)
{
  int i, ndeletions;
  int headroom = -1;
  if (delete_Nsteps > 0) {
...
double FixReaxFFSpeciesSVE::compute_vector(int n)
{
...
int FixReaxFFSpeciesSVE::nint(const double &r)
{
  int i = 0;
  if (r > 0.0)
...
int FixReaxFFSpeciesSVE::pack_forward_comm(int n, int *list, double *buf, int /*pbc_flag*/,
                                        int * /*pbc*/)
{
  int i, j, m;
...
void FixReaxFFSpeciesSVE::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m, last;
...
double FixReaxFFSpeciesSVE::memory_usage()
{
  double bytes;
